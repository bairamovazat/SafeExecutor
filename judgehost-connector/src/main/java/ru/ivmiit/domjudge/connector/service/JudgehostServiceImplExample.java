...
//@Service
@Deprecated
public class JudgehostServiceImplExample implements JudgehostService {
    ...
    @Override
    public Integer addJudgingRun(String hostName, Long judgingId, List<AddJudgingRunDto> addJudgingRunDto) {
